                           ...
                           QGraphicsScene *scene_room)
{
    ...
    if(robot_scene)
    {
        ...
        { robot_scene->removeItem(p); delete p;}
        doors_draw.clear();
        ...
        {
            const auto peak_A_draw = robot_scene->addEllipse(-100, -100, 200, 200, pen, brush);
            const auto peak_B_draw = robot_scene->addEllipse(-100, -100, 200, 200, pen, brush);
            peak_A_draw->setPos(d.p1.x(), d.p1.y());
            peak_B_draw->setPos(d.p2.x(), d.p2.y());
            const auto line_draw = robot_scene->addLine(d.p1.x(), d.p1.y(), d.p2.x(), d.p2.y(), QPen(Qt::cyan, 30));
